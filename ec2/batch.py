...
plt.ylabel('Frequency')
plt.tight_layout()
plt.savefig('startup_time_summary_ec2.png')
# 单独保存每张图
fig, ax = plt.subplots()
...
fig.savefig('images/cold_start_total_time_PublicImage.png')
plt.close(fig)
fig, ax = plt.subplots()
...
ax.set_xlabel('Total Time (ms)')
ax.set_ylabel('Frequency')
fig.savefig('images/hot_start_total_time_PublicImage.png')
plt.close(fig)
fig, ax = plt.subplots()
...
ax.set_ylabel('Frequency')
fig.savefig('images/cold_start_pull_time_PublicImage.png')
plt.close(fig)
fig, ax = plt.subplots()
...
ax.set_xlabel('Pull Time (ms)')
ax.set_ylabel('Frequency')
fig.savefig('images/hot_start_pull_time_PublicImage.png')
plt.close(fig)
fig, ax = plt.subplots()
...
ax.set_ylabel('Frequency')
fig.savefig('images/cold_start_prepare_time_PublicImage.png')
plt.close(fig)
fig, ax = plt.subplots()
...
ax.set_xlabel('Preparation Time (ms)')
ax.set_ylabel('Frequency')
fig.savefig('images/hot_start_prepare_time_PublicImage.png')
plt.close(fig)
